...
const ContainerExample = () =>
  <Section className='container-example' id='container'>
    <Container>
      ...
      <p>Containers, também podem ser chamados de "composable component", e servem para juntar pequenos componentes. No nosso caso, como estamos trabalhando com portais, eles se tornam muito úteis, pois podemos notar componentes em comum em quase todas as páginas, como Header, Menu e Footer.</p>
      <br />
      <p>Um dos erros mais comuns é o código não ser consistente entre design e o CMS (ou regras de negócio), o que torna a manutenção e a clareza da aplicação muito mais complexa.</p>
